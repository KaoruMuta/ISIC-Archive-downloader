...
def download_descriptions(ids, descs_dir, num_processes):
    """
...
def download_descriptions_and_filter(ids, num_images_requested, filter, descs_dir):
    """
...
def download_images(descriptions, images_dir, num_processes):
